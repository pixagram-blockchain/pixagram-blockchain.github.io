    ...
    return (
        ...
        >
            <DialogContent className={classes.darkDialogContent}>
                ...
                <Typography variant="body2" style={LINK_TARGET_STYLE}>{t("components.dialogs.linking", {
                        snippet: snippet
                    })}</Typography>
                <TextField
            ...
            <DialogActions className={classes.darkDialogActions}>
                <Button onClick={onClose}>{t("words.cancel")}</Button>
                <Button
                    variant="contained"
                    onClick={onInsert}
                    disabled={!canInsert}
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                ...
                >
                    {busy ? 'Uploading to Arweave…' : 'Upload from device'}
                </Button>
