...
function PaperCardCommentInner({
    ...
    const handleUpvote = useCallback(() => {
        ...
        if (api) {
            api.broadcast.vote(voter, authorUsername, permlink, weight)
                ...
                .catch((e) => {
                    console.warn('[PaperCardComment] vote failed:', e.message);
...
const PaperCardComment = withStyles(styles)(PaperCardCommentInner);

export default PaperCardComment;