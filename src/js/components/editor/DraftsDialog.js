            ...
            {loading ? (
                ...
                <div className={classes.emptyState}>
                    ...
                    <Typography variant="h5" gutterBottom style={EMPTY_TITLE_STYLE}>
                        {searchQuery ? t("components.drafts_dialog.no_drafts_found") : t("components.drafts_dialog.no_drafts_yet")}
                    </Typography>
                    <Typography variant="body1" style={EMPTY_BODY_STYLE}>
                        {searchQuery ? t("components.drafts_dialog.try_a_different_search_query") : t("components.drafts_dialog.start_writing_to_save_your_first_draft")}
                    </Typography>
                </div>
            ) : (
