                ...
                (editorMode !== 'visual' || (mobile && parseInt(tab) === 1)) ? null:
                    <Grow in={(parseInt(tab) === 0 || !mobile) && editorMode === 'visual'}>
                        <div className={`${classes.fixedSidebar} ${editOpened ? 'opened' : ''}`}>
                            ...
                            <Tooltip title={t("components.editor_toolbar.bold_ctrl_b")} placement="right" classes={tooltipClasses}>
                                <IconButton
                            ...
                            <Tooltip title={t("components.editor_toolbar.italic_ctrl_i")} placement="right" classes={tooltipClasses}>
                                <IconButton
                            ...
                            <Tooltip title={t("components.editor_toolbar.undo")} placement="right" classes={tooltipClasses}>
