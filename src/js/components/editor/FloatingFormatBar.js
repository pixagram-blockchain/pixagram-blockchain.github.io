...
const FloatingFormatBar = ({ onLink, onToggleBlockType }) => {
    ...
    return createPortal(
        ...
        >
            <IconButton
                size="small"
                title={t("components.floating_format_bar.bold_ctrl_b")}
            ...
            <IconButton
                size="small"
                title={t("components.floating_format_bar.italic_ctrl_i")}
            ...
            <IconButton
                size="small"
                title={t("components.floating_format_bar.heading_1")}
            ...
            <IconButton
                size="small"
                title={t("components.floating_format_bar.heading_2")}
