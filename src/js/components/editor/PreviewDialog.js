        ...
        >
            ...
            <DialogContent className={classes.previewDialogContent}>
                <Typography className={classes.previewTitle}>
                    {title || t("components.preview_dialog.untitled")}
                </Typography>
            ...
            <div className={classes.previewDialogActions}>
                <Box display="flex" alignItems="center" color="rgba(255,255,255,0.6)">
                    <Typography variant="caption">
                        {t("components.preview_dialog.words_min_read", { wordCount, readingTime })}
                    </Typography>
                </Box>
                <Button
                    variant="contained"
                    ...
                    title={!activeAccount ? t("components.preview_dialog.log_in_to_publish") : undefined}
                >
                    {isPublishing
                        ? (editMode ? t("components.preview_dialog.updating") : t("components.preview_dialog.publishing"))
                        : (editMode ? t("components.preview_dialog.update") : t("components.preview_dialog.publish"))}
                </Button>
            </div>
        </Dialog>
    );
