...
function SvgEmojiU1F307(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f307_svg__a"
        cx={88.195}
        cy={51.501}
        r={56.382}
      ...
      <path
        ...
        fill="url(#emoji_u1f307_svg__a)"
      />
      <radialGradient
        id="emoji_u1f307_svg__b"
        cx={25.529}
        cy={113.093}
        r={140.58}
        gradientUnits="userSpaceOnUse"
      ...
      <path
        d="M116.62 124.26H11.32c-4.15 0-7.52-3.37-7.52-7.52V11.44c0-4.15 3.37-7.52 7.52-7.52h105.3c4.15 0 7.52 3.37 7.52 7.52v105.3c.01 4.15-3.36 7.52-7.52 7.52z"
        fill="url(#emoji_u1f307_svg__b)"
      />
      <radialGradient
        id="emoji_u1f307_svg__c"
        cx={87.87}
        cy={113.71}
        r={112.193}
        gradientUnits="userSpaceOnUse"
      ...
      <path
        ...
        fill="url(#emoji_u1f307_svg__d)"
      />
      <path d="M5.71 116.21h29.97v2.35H5.71z" fill="#fc7143" />
      <path d="M5.71 107.86h29.97v2.35H5.71z" fill="#fc7444" />
      <path d="M5.71 99.21h29.97v2.35H5.71z" fill="#fc7c47" />
      <path d="M5.71 90.86h29.97v2.35H5.71z" fill="#fd894a" />
      <path d="M5.71 81.21h29.97v2.35H5.71z" fill="#fda152" />
      <path d="M5.71 72.86h29.97v2.35H5.71z" fill="#fcb95a" />
      <path
      ...
      />
      <path
        d="M23.11 49.174l2-.007.06 18.65-2 .007zM16.098 28.486h2v39.39h-2zM102.304 63.351l.006-2 11.86.036-.006 2z"
        fill="#fff6b2"
      />
      <path
        d="M99.13 93.11l-.01-2L114 91.1V48.4l10.16.01-.01 2-8.15-.01v42.7zM94.02 67.1h5.11v2h-5.11zm-17.9-7.34h5.19v2h-5.19zm-5.35 7.17h5.36v2h-5.36zm-3.05 35.95h-2v-40h2.35v-5.44h-2.35V42.03h-2.38l-3.88-12 .03-11.18h2l-.03 10.86.25.74 3.09 9.58h2.92v15.41h2.35v9.44h-2.35z"
        fill="#fff6b2"
      />
      <radialGradient
        id="emoji_u1f307_svg__e"
        cx={91.818}
        cy={49.529}
        r={22.854}
      ...
      <ellipse
        ...
        ry={30.07}
        opacity={0.63}
        fill="url(#emoji_u1f307_svg__e)"
      />
    </svg>
  );
}

export default SvgEmojiU1F307;
