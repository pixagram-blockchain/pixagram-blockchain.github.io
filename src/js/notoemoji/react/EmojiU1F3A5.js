...
function SvgEmojiU1F3A5(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      ...
      <path
        d="M121.11 73.45L116 76h-16v12h16l5.11 2.55c1.33.66 2.89-.3 2.89-1.79V75.24c0-1.49-1.56-2.46-2.89-1.79z"
        fill="#595858"
      />
      <path d="M64 48h28v28H64z" fill="#3f3f3f" />
      <path d="M31.5 80h3v28h-3z" fill="#787676" opacity={0.5} />
      ...
      />
      <path
        d="M54 94c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m0-2c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 10c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m0-2c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"
        fill="#3a3a3a"
      />
      <path
      ...
      <circle cx={54} cy={96} r={2} fill="url(#emoji_u1f3a5_svg__a)" />
      <linearGradient
        id="emoji_u1f3a5_svg__b"
        gradientUnits="userSpaceOnUse"
        x1={54}
        y1={26.14}
        x2={54}
      ...
      <circle cx={54} cy={104} r={2} fill="url(#emoji_u1f3a5_svg__b)" />
    </svg>
  );
}

export default SvgEmojiU1F3A5;
