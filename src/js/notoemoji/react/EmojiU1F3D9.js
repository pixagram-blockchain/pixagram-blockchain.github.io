...
function SvgEmojiU1F3D9(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f3d9_svg__a"
        cx={65.983}
        cy={98.45}
        r={98.33}
      ...
      <path
        ...
        fill="url(#emoji_u1f3d9_svg__b)"
      />
      <path
        d="M5.71 116.21h29.97v2.35H5.71zm0-8.35h29.97v2.35H5.71z"
        fill="#88babc"
      />
      <path d="M5.71 99.21h29.97v2.35H5.71z" fill="#abd7db" />
      <path
        d="M5.71 90.86h29.97v2.35H5.71zm0-9.65h29.97v2.35H5.71zm0-8.35h29.97v2.35H5.71z"
        fill="#dcedf6"
      />
      <path d="M5.71 63.32h1.76v3.7H5.71zm6 0h1.76v3.7h-1.76z" fill="#88babc" />
      <path d="M5.71 55.89h1.76v3.7H5.71zm6 0h1.76v3.7h-1.76z" fill="#abd7db" />
      <path
        d="M5.71 48.46h1.76v3.7H5.71zm6 0h1.76v3.7h-1.76zm-6-7.43h1.76v3.7H5.71zm6 0h1.76v3.7h-1.76zm-6-7.44h1.76v3.7H5.71zm6 0h1.76v3.7h-1.76zM49.8 64.51h2.27v4.76H49.8zm5.38 0h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27zm-10.56 9h2.27v4.76H49.8z"
        fill="#dcedf6"
      />
      <path
      ...
      />
      <path
        d="M55.18 73.51h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27z"
        fill="#dcedf6"
      />
      <path
      ...
      />
      <path
        d="M76.37 107.03h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm-15.64 9.47h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z"
        fill="#88babc"
      />
    </svg>
  );
