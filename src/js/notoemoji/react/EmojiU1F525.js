...
function SvgEmojiU1F525(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f525_svg__a"
        cx={68.884}
        cy={124.296}
        r={70.587}
      ...
      <path
        ...
        fill="url(#emoji_u1f525_svg__a)"
      />
      <radialGradient
        id="emoji_u1f525_svg__b"
        cx={64.921}
        cy={54.062}
        r={73.86}
      ...
      <path
        ...
        fill="url(#emoji_u1f525_svg__b)"
      />
    </svg>
  );
}

export default SvgEmojiU1F525;
